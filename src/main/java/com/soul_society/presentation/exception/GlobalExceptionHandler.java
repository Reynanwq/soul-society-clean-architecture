package com.soul_society.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ShinigamiNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleShinigamiNotFound(ShinigamiNotFoundException ex) {
